...
The dviz.supp package contains the dataset we are working with. The themes are provided by the cowplot package, of which we need a version >= 0.9.99. As of this writing, this is not yet available on CRAN.
```{r}
